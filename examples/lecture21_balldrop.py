...
# Create a sphere
ball = m.Shape(m.Sphere(radius=0.03), static=False, mass=1.0, position=[0, 0, 1.5], rgba=[1, 0, 0, 1])
...
# Create a sphere
ball = m.Shape(m.Sphere(radius=0.03), static=False, mass=1.0, position=[0.5, 0, 1.5], rgba=[1, 0, 0, 1])
ball.set_whole_body_frictions(lateral_friction=0, spinning_friction=0, rolling_friction=0)
ball.set_restitution(0.5)
