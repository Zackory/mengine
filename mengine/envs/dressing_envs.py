...
class DressingPR2IKMeshEnv(DressingEnv):
    def __init__(self):
        super(DressingPR2IKMeshEnv, self).__init__(robot=PR2(robot_arm), human=None, use_ik=True)
...
class DressingPR2IKEnv(DressingEnv):
    def __init__(self):
        super(DressingPR2IKEnv, self).__init__(robot=PR2(robot_arm), human=Human(human_controllable_joint_indices, controllable=False), use_ik=True)
